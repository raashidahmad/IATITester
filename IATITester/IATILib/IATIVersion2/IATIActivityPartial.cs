...
using static IATITester.IATILib.Models.DropdownItem;
...
namespace IATITester.IATILib.IATIVersion2
{
    ...
    public partial class iatiactivity
    {
        ...
        public List<transaction> Commitments
        {
            get
            {
                return GetTransactions(ConvertIATIVersion2.gettransactionCode("C"));
            }
        }
        [XmlIgnore]
        ...
        public List<planneddisbursement> PlannedDisbursments
        {
            get
            {
                var plannedDisbursments = new List<planneddisbursement>();
        ...
        public List<transaction> Disbursments
        {
            get
            {
                var disbursments = GetTransactions(ConvertIATIVersion2.gettransactionCode("D"));
                //expenditures in IATI are also treated as disbursments in AIMS
                disbursments.AddRange(GetTransactions(ConvertIATIVersion2.gettransactionCode("E")));
                return disbursments;
            }
        }
        [XmlIgnore]
